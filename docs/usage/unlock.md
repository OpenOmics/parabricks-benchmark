# <code>parabricks-benchmark <b>unlock</b></code>
...
This part of the documentation describes options and concepts for <code>parabricks-benchmark <b>unlock</b></code> sub command in more detail. With minimal configuration, the **`unlock`** sub command enables you to unlock a pipeline output directory. 
...
Unlocking parabricks-benchmark pipeline output directory is fast and easy! In its most basic form, <code>parabricks-benchmark <b>unlock</b></code> only has *one required input*.

## 2. Synopsis
```text
$ ./parabricks-benchmark unlock [-h] --output OUTPUT
```
...
parabricks-benchmark unlock --output /data/$USER/output
```